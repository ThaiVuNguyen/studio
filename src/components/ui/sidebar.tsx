  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
            "group peer hidden md:flex md:flex-col text-foreground transition-all duration-200",
